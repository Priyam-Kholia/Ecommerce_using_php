...
// getting total items and total price of all item in cart\
...
// getting qunatity from the cart
...
if($insert_orders){
    ...
    echo"<script>window.open('profile.php?invoice_number=$invoice_number','_self')</script>";
}
